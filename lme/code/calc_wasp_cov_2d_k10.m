...
function calc_wasp_cov_2d_k10(dd, nsub, ndim, dirp)
...
for pp = 1:2 
    for dims = 1:ndim
        ...
        csvwrite(strcat(dirp, 'joint/wasp_cov_cv_',  num2str(dd), '_p_', num2str(pp), '_d_', num2str(dims), '_k10.csv'), summ);
