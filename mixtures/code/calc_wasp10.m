function calc_wasp10(dd, nsub, ndim)
...
margMat = {};
for kk = 1:nsub 
    margMat{kk} = csvread(strcat('/Shared/ssrivastva/wasp/mixtures/result/sub10/samp/csv/samp_cv_', ...
                                 num2str(dd), '_nsub_', num2str(kk), '_k10_', chr, '.csv'));
end
runtime = 0;
...
save(strcat('/Shared/ssrivastva/wasp/mixtures/result/sub10/res_cv_', num2str(dd), ...
            '_', chr, '_k10.mat'), 'runtime', 'tmats','avec', 'subsetPost', 'overallPost');
summ = [overallPost avec];
csvwrite(strcat('/Shared/ssrivastva/wasp/mixtures/result/sub10/wasp_cv_', num2str(dd), ...
                '_', chr, '_k10.csv'), summ);
csvwrite(strcat('/Shared/ssrivastva/wasp/mixtures/result/sub10/overall_cv_', num2str(dd), ...
                '_', chr, '_k10.csv'), overallPost);
csvwrite(strcat('/Shared/ssrivastva/wasp/mixtures/result/sub10/time_cv_', num2str(dd), ...
                '_', chr, '_k10.csv'), runtime);    
quit
