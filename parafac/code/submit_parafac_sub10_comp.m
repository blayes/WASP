function submit_parafac_sub10_comp(dd, nclass, nsub, nrun, nburn, nthin)
...
save(strcat('/Shared/ssrivastva/wasp/parafac/result/comp/sub10/samp/res_cv_', num2str(nrepf), '_sub_', num2str(nsubf), '_k10.mat'), 'history', 'tend');    
csvwrite(strcat('/Shared/ssrivastva/wasp/parafac/result/comp/sub10/samp/time_cv_', num2str(nrepf), '_sub_', num2str(nsubf), '_k10.csv'), tend);
